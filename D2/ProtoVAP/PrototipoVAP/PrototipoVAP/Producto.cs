...
namespace PrototipoVAP
{
    public class Producto
    {
        ...
        public Producto(int id, string concepto, string tipo, string marca, int precio, string imgBlanco, string imgNegro)
        {
            this.id = id;
        ...
        public Producto(int id, string concepto, string tipo, string marca, int precio, string imgBlanco, string imgNegro, ArrayList v)
        {
            this.id = id;
            this.concepto = concepto;
            this.precio = precio;
